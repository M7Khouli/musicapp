...
for (var i = 0; i < fingerprint.length; i++) {
    // Use Math.min to limit the offset within the valid range (0 to 308)
    var offset = Math.min(Number(i) * 4, 308);
    results.fingerprint.writeBigInt64BE(BigInt(fingerprint[i]), offset, true);
}
